     ...
     */
        function createView($content, $conf)
        {
            ...
            if ($this->piVars["submitCreate"] && !$this->read_only && !$this->read_only)
            {
                ...
                $content .= '<input type="Submit" name="'.$this->prefixId.'[submitCreate]" value="'.$this->pi_getLL("pi_edit_save", "Save Page").'" accesskey="s" title="[Alt+s] '.$this->pi_getLL("pi_edit_save", "Save Page").'" tabindex="2" />&nbsp;';
                ...
                $content .= '<input type="Submit" name="'.$this->prefixId.'[submitCreate]" value="'.$this->pi_getLL("pi_edit_save", "Save Page").'" tabindex="3" accesskey="s" title="[Alt+s] '.$this->pi_getLL("pi_edit_save", "Save Page").'" />&nbsp;';
                $content .= '<input type="reset" value="'.$this->pi_getLL("pi_edit_reset", "Reset").'">';
